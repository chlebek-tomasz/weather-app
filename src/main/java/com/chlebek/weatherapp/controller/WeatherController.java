package com.chlebek.weatherapp.controller;

import com.chlebek.weatherapp.model.CityWeatherInfo;
import com.chlebek.weatherapp.request.CityWeatherRequest;
...
public class WeatherController {
    ...
    public @ResponseBody
    CityWeatherInfo getCity(@PathVariable("name") String cityName) {
